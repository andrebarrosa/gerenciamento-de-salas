    ...
    switch ($_REQUEST["acao"]) {
        ...
        case "editar":
            ...
            if($res == true) {
                ...
                print "<script>alert('Não foi possível editar um evento.');</script>";
                print "<script>location.href='?page=salas';</script>"; 
            }
        ...
        case "excluir":
            $sql = "DELETE FROM fatos_eventos WHERE id=".$_REQUEST["id"];
                ...
                if($res == true) {
                    print "<script>alert('Evento excluida com sucesso!');</script>";
                    print "<script>location.href='?page=eventos';</script>";
                } else {
                    print "<script>alert('Não foi possível excluir evento.');</script>";
                    print "<script>location.href='?page=eventos';</script>"; 
                }
