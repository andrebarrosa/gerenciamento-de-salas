<div class='card-box d-flex justify-content-between'>
     ...
     <div onclick="window.location.href='?page=usuario'" class='card-item d-flex justify-content-around align-items-center'>
          <div class="title">
               <h5>Usuário</h5>
               <p class="text-center">0</p>
          </div>
     ...
     <div onclick="window.location.href='?page=cliente'" class='card-item bg-dark d-flex justify-content-around align-items-center'>
          <div class="title">
               <h5>Clientes</h5>
               <p class="text-center">0</p>
          </div>
